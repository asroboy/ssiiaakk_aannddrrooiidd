...
import com.uika.siak.MainActivity;
...
public class SessionManager {
	...
	public SessionManager(Context context) {
		...
		pref = _context.getSharedPreferences(ConstantValues.PREFERENCES_NAME,
				PRIVATE_MODE);
		editor = pref.edit();
	}
	...
	public HashMap<String, String> getUserDetails() {
		...
		user.put(KEY_REAL_NAME, pref.getString(KEY_REAL_NAME, null));
